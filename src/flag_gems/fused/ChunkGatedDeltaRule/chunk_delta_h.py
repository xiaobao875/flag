...
from flag_gems.fused.ChunkGatedDeltaRule.index import (
    prepare_chunk_indices,
    prepare_chunk_offsets,
)
from flag_gems.fused.ChunkGatedDeltaRule.triton_ops_helper import exp2
from flag_gems.fused.ChunkGatedDeltaRule.utils import use_cuda_graph
...
def chunk_gated_delta_rule_fwd_kernel_h_blockdim64(
    ...
    for i_t in range(NT):
        ...
        if USE_G:
            ...
            # Apply exp2(g) to w, matching GatedDeltaNet implementation
            b_w = (b_w * exp2(b_g)[:, None]).to(b_w.dtype)
